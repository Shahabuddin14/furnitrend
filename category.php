      ...
      <div class="cat_img" style="padding: 60px 0 0 0">
            ...
            <div class="container">
              <div class="col-md-8 offset-md-4">
                   <img src="img/<?php echo $cat_img?>" alt="" height="300px" width="100%">
          <?php }   ?> 
              </div>
            </div>
...
<!--
                                <div class="single_product_menu">
                                   ...
                                   <?php 
                                    ...
                                    $showproductnumber = mysqli_num_rows($query);
                                    
                                    
                                    ?>
                                   
                                   
                                    <p><span><?php echo $showproductnumber; ?> </span> Products Found</p>
                                </div>
-->
<!--
